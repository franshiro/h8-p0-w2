...
console.log('-------------------------------------------------');
console.log('Exercises 5 no.2');

var word = 'wow JavaScript is so coolwow JavaScrip ';
...
var thirdWord3 = word.substring(14,17); // do your own!
...
var thirdWord4 = word.substring(14,17); // do your own!
